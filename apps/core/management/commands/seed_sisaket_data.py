...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        sisaket_locations = [
            {
                ...
                'latitude': 15.10272628082741,
                'longitude': 104.30525366091227,
                'category': cat_map['nature'],
                'cover_image_url': '/static/images/locations/somdet-park-sisaket.jpg',
            ...
            },
            {
                ...
                'latitude': 15.11841712640784,
                'longitude': 104.32856712745337,
                'category': cat_map['temple'],
                'cover_image_url': 'https://img-prod.api-onscene.com/cdn-cgi/image/format=auto,width=3200/https://sls-prod.api-onscene.com/partner_files/trueidintrend/11817/IMG_20191122_142141116_HDR.jpg',
            ...
            },
            {
                ...
                'latitude': 15.090431489473437,
                'longitude': 104.3270738962337,
                'category': cat_map['travel'],
                'cover_image_url': 'https://scontent.fnak2-1.fna.fbcdn.net/v/t39.30808-6/486805825_654335250796403_3336312840085069722_n.jpg?stp=dst-jpg_tt6&cstp=mx2048x1537&ctp=s2048x1537&_nc_cat=100&ccb=1-7&_nc_sid=127cfc&_nc_eui2=AeHH2WXi6X-XYTVNjC_cl1qZY_0b_77UDSdj_Rv_vtQNJ5KZlU7HhBaguwIN-mWqcHiPxWXPU_H1UoYZqjEfeE62&_nc_ohc=aTknCIQoQQ8Q7kNvwF8jAb1&_nc_oc=Adqe6fnHMoQc2Yt1TVXrEUQ0Gr2Nc8uF9dRjNgnSkIrkx_C2uTrXcDVCMxsNf1QbvhivnxlIXEMqoDMQAEHypWhv&_nc_zt=23&_nc_ht=scontent.fnak2-1.fna&_nc_gid=xn-gE09P8_disxrzSmz1Cg&_nc_ss=7b2a8&oh=00_AQL9s4vrEmk-ZIsZF1CmTAjm-YPBJAsRlWJH2x8YrBGN2w&oe=6AA390A7',
            ...
            },
            {
                ...
                'latitude': 15.118988244406996,
                'longitude': 104.32319224791348,
                'category': cat_map['temple'],
                'cover_image_url': '/static/images/locations/sisaket-city-pillar-shrine.jpg',
            ...
            },
            {
                ...
                'latitude': 15.093780600857706,
                'longitude': 104.32975781062984,
                'category': cat_map['viewpoint'],
                'cover_image_url': '/static/images/locations/srilamduan-tower.png',
            ...
            },
            {
                ...
                'latitude': 15.194951827221198,
                'longitude': 104.29611397548547,
                'category': cat_map['temple'],
                'cover_image_url': '/static/images/locations/wat-phra-that-suphannahong.jpg',
            ...
            },
            {
                ...
                'longitude': 104.41876,
                'category': cat_map['temple'],
                'cover_image_url': '/static/images/locations/wat-pa-maha-chedi-kaew.jpg',
            ...
            },
            {
                ...
                'latitude': 14.401840992049259,
                'longitude': 104.68612107170334,
                'category': cat_map['viewpoint'],
                'cover_image_url': '/static/images/locations/pha-mo-e-daeng.jpg',
            ...
            },
            {
                ...
                'latitude': 15.101657,
                'longitude': 104.127877,
                'category': cat_map['temple'],
                'cover_image_url': '/static/images/locations/wat-sa-kampaeng-yai.jpg',
            ...
            },
            {
                ...
                'province': 'ศรีสะเกษ',
                'address': 'ต.หนองครก อ.เมืองศรีสะเกษ จ.ศรีสะเกษ',
                'latitude': 15.092728398497155,
                'longitude': 104.3284535062441,
                'category': cat_map['nature'],
                'cover_image_url': '/static/images/locations/huai-nam-kham-park.jpg',
        ...
        for l_data in sisaket_locations:
            ...
            loc.latitude = l_data['latitude']
            loc.longitude = l_data['longitude']
        ...
        posts_data = [
            ...
            {
                'user': user_film,
                'loc': loc_obj_map['huai-nam-kham-park'],
                'cat': cat_map['nature'],
                'caption': 'มาวิ่งออกกำลังกายและชมวิวพระอาทิตย์ตกที่เกาะกลางน้ำห้วยน้ำคำครับ 🏃‍♂️🌅',
                'cover': loc_obj_map['huai-nam-kham-park'].cover_image_url,
                'hours_ago': 24
            }
        ]
